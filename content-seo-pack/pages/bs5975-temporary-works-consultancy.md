...
- Aligning roles, responsibilities, registers and forms with BS 5975:2024

### Design briefs
- Preparing structured design briefs for individual temporary works items
- Supporting Permanent Works Designers in providing inputs to the brief

### Register and category management
- Setting up a Temporary Works Register
- Confirming check categories (CAT 1 / 2 / 3)
- Tracking design and check status against programme

### Coordinator and Supervisor support
- Acting as overflow design / check capacity for in-house TWCs
- Providing technical input on bespoke or unusual items
- Reviewing third-party submissions and contractor proposals

### Permits and inspections
- Permit-to-load / permit-to-dig inputs
...
## Closing CTA
**Need BS 5975:2024 support on a current project?**
