...
### CAT 2
A check by a competent person independent of the original designer, suitable for more complex temporary works with a moderate risk profile.

### CAT 3
A check by a competent designer independent of the original designer **and** from a separate organisation, suitable for complex, high-risk or unusual temporary works. CAT 3 checking is a core service offered.
...
- Review of drawings against calculations
- Comments returned in a clear schedule
...
- Excavation support — sheet piling, soldier piles, batters
- Working platforms (BRE 470) and crane bases
- Hoardings and temporary façade retention
- Scaffold foundations and load spreading
...
## Closing CTA
**Need a CAT 3 check on a tight programme?**
